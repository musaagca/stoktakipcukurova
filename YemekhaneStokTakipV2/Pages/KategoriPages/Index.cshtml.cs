...
public class IndexModel : PageModel
{
    ...
    public async Task OnGetAsync() { var q = _context.Kategoriler.AsQueryable(); if (!string.IsNullOrWhiteSpace(Ara)) q = q.Where(x => x.KategoriAdi.Contains(Ara)); Kategori = await q.OrderBy(x => x.KategoriAdi).ToListAsync(); }
}